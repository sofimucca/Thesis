...
\vspace{27mm}
\begin{spacing}{1.4}
\vspace{1cm}{\LARGE{\bf Aggiungere titolo}}\\
...
\end{spacing}
\vspace{5mm}
{\large{\bf Sessione \MakeUppercase{\romannumeral 1} \\
...
\label{ch1}
\subfile{chapters/ch1-intro}

\clearpage
\chapter{Monkeys are cute animals}
\label{ch2}
\subfile{chapters/ch2-monkeys}

\clearpage
\chapter{Capybaras are absolutely hilarious}
\label{ch3}
\subfile{chapters/ch3-capy}
